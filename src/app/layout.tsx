...
export const metadata: Metadata = {
  ...
  description:
    "Decentralized chat Starter Guide for Developers and Users of the Decentralized Chat. Learn how to use the Decentralized Chat to build your own decentralized applications. ",
};
